...
export default () => (
  <React.Fragment>
    <h2>
      An interactive essay on the development lifetime of a
    ...
    <small>
      ...
      explore through thesf sdfsdfsfsdfsdfsdf sdf sd f
      development of a shopping app, that our current
      methods are ineffective when modeling a system that
      (i) constantly changes, and (ii) has a variety of
      people working on it that come and go. As a system
      becomes more complex it becomes inevitably harder to
      maintain and modify. As a result we will ask
